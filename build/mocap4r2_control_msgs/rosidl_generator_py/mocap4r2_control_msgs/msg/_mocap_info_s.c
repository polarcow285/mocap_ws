...
bool mocap4r2_control_msgs__msg__mocap_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap4r2_control_msgs.msg._mocap_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("MocapInfo", (char *)PyUnicode_1BYTE_DATA(name_attr), 9) == 0);
