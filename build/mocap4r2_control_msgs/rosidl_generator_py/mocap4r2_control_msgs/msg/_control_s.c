...
bool mocap4r2_control_msgs__msg__control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap4r2_control_msgs.msg._control", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("Control", (char *)PyUnicode_1BYTE_DATA(name_attr), 7) == 0);
