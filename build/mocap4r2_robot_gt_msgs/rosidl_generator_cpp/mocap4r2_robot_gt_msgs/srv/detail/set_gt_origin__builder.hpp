...
class Init_SetGTOrigin_Event_response
{
public:
  explicit Init_SetGTOrigin_Event_response(::mocap4r2_robot_gt_msgs::srv::SetGTOrigin_Event & msg)
  : msg_(msg)
  {}
  ::mocap4r2_robot_gt_msgs::srv::SetGTOrigin_Event response(::mocap4r2_robot_gt_msgs::srv::SetGTOrigin_Event::_response_type arg)
  {
...
private:
  ::mocap4r2_robot_gt_msgs::srv::SetGTOrigin_Event msg_;
};

class Init_SetGTOrigin_Event_request
{
public:
  explicit Init_SetGTOrigin_Event_request(::mocap4r2_robot_gt_msgs::srv::SetGTOrigin_Event & msg)
  : msg_(msg)
  {}
  Init_SetGTOrigin_Event_response request(::mocap4r2_robot_gt_msgs::srv::SetGTOrigin_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetGTOrigin_Event_response(msg_);
  }
...
class Init_SetGTOrigin_Event_info
{
public:
  Init_SetGTOrigin_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetGTOrigin_Event_request info(::mocap4r2_robot_gt_msgs::srv::SetGTOrigin_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetGTOrigin_Event_request(msg_);
  }
...
template<>
inline
auto build<::mocap4r2_robot_gt_msgs::srv::SetGTOrigin_Event>()
{
  return mocap4r2_robot_gt_msgs::srv::builder::Init_SetGTOrigin_Event_info();
}
