...
static const _SetGTOrigin_Event_type_support_symbol_names_t _SetGTOrigin_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mocap4r2_robot_gt_msgs, srv, SetGTOrigin_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mocap4r2_robot_gt_msgs, srv, SetGTOrigin_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mocap4r2_robot_gt_msgs, srv, SetGTOrigin_Event)() {
  return &::mocap4r2_robot_gt_msgs::srv::rosidl_typesupport_c::SetGTOrigin_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetGTOrigin_service_type_support_handle = {
  ...
  &SetGTOrigin_Request_message_type_support_handle,
  &SetGTOrigin_Response_message_type_support_handle,
  &SetGTOrigin_Event_message_type_support_handle,
