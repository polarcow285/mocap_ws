...
inline void to_flow_style_yaml(
  const SetMarkerColor_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const SetMarkerColor_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use mocap4r2_marker_viz_srvs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const mocap4r2_marker_viz_srvs::srv::SetMarkerColor_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  mocap4r2_marker_viz_srvs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use mocap4r2_marker_viz_srvs::srv::to_yaml() instead")]]
inline std::string to_yaml(const mocap4r2_marker_viz_srvs::srv::SetMarkerColor_Event & msg)
{
  return mocap4r2_marker_viz_srvs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<mocap4r2_marker_viz_srvs::srv::SetMarkerColor_Event>()
{
  return "mocap4r2_marker_viz_srvs::srv::SetMarkerColor_Event";
}

template<>
inline const char * name<mocap4r2_marker_viz_srvs::srv::SetMarkerColor_Event>()
{
  return "mocap4r2_marker_viz_srvs/srv/SetMarkerColor_Event";
}

template<>
struct has_fixed_size<mocap4r2_marker_viz_srvs::srv::SetMarkerColor_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<mocap4r2_marker_viz_srvs::srv::SetMarkerColor_Event>
  : std::integral_constant<bool, has_bounded_size<mocap4r2_marker_viz_srvs::srv::SetMarkerColor_Request>::value && has_bounded_size<mocap4r2_marker_viz_srvs::srv::SetMarkerColor_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<mocap4r2_marker_viz_srvs::srv::SetMarkerColor_Event>
  : std::true_type {};
