...
bool mocap4r2_marker_viz_srvs__srv__set_marker_color__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap4r2_marker_viz_srvs.srv._set_marker_color", (char *)PyUnicode_1BYTE_DATA(module_attr), 46) == 0);
    assert(strncmp("SetMarkerColor_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
...
bool mocap4r2_marker_viz_srvs__srv__set_marker_color__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("mocap4r2_marker_viz_srvs.srv._set_marker_color", (char *)PyUnicode_1BYTE_DATA(module_attr), 46) == 0);
    assert(strncmp("SetMarkerColor_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
...
bool mocap4r2_marker_viz_srvs__srv__set_marker_color__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("mocap4r2_marker_viz_srvs.srv._set_marker_color", (char *)PyUnicode_1BYTE_DATA(module_attr), 46) == 0);
    assert(strncmp("SetMarkerColor_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);
