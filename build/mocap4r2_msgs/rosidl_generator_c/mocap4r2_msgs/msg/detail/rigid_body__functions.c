...
mocap4r2_msgs__msg__RigidBody__create(void)
{
  ...
  mocap4r2_msgs__msg__RigidBody__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    mocap4r2_msgs__msg__RigidBody * data =
      (mocap4r2_msgs__msg__RigidBody *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mocap4r2_msgs__msg__RigidBody__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mocap4r2_msgs__msg__RigidBody__fini(&output->data[i]);
        }
        return false;
      }
    }
