...
#ifndef MOCAP4R2_MSGS__SRV__DETAIL__CREATE_RIGID_BODY__FUNCTIONS_H_
#define MOCAP4R2_MSGS__SRV__DETAIL__CREATE_RIGID_BODY__FUNCTIONS_H_
...
/// Initialize srv/CreateRigidBody message.
/**
...
/// Finalize srv/CreateRigidBody message.
/**
...
/// Create srv/CreateRigidBody message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mocap4r2_msgs__srv__CreateRigidBody_Request__init().
...
/// Destroy srv/CreateRigidBody message.
/**
 * It calls
 * mocap4r2_msgs__srv__CreateRigidBody_Request__fini()
...
/// Check for srv/CreateRigidBody message equality.
/**
...
/// Copy a srv/CreateRigidBody message.
/**
...
/// Initialize array of srv/CreateRigidBody messages.
/**
...
/// Finalize array of srv/CreateRigidBody messages.
/**
 * It calls
 * mocap4r2_msgs__srv__CreateRigidBody_Request__fini()
...
/// Create array of srv/CreateRigidBody messages.
/**
...
/// Destroy array of srv/CreateRigidBody messages.
/**
 * It calls
 * mocap4r2_msgs__srv__CreateRigidBody_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CreateRigidBody message array equality.
/**
...
/// Copy an array of srv/CreateRigidBody messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mocap4r2_msgs__srv__CreateRigidBody_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mocap4r2_msgs
...
/**
 * It calls
 * mocap4r2_msgs__srv__CreateRigidBody_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mocap4r2_msgs
...
/**
 * It calls
 * mocap4r2_msgs__srv__CreateRigidBody_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * mocap4r2_msgs__srv__CreateRigidBody_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_mocap4r2_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mocap4r2_msgs__srv__CreateRigidBody_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mocap4r2_msgs
...
/**
 * It calls
 * mocap4r2_msgs__srv__CreateRigidBody_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mocap4r2_msgs
...
/**
 * It allocates the memory for the array and calls
 * mocap4r2_msgs__srv__CreateRigidBody_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mocap4r2_msgs
...
/**
 * It calls
 * mocap4r2_msgs__srv__CreateRigidBody_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOCAP4R2_MSGS__SRV__DETAIL__CREATE_RIGID_BODY__FUNCTIONS_H_
