...
{
  const auto & item = *reinterpret_cast<const mocap4r2_msgs::msg::RigidBody *>(
    get_const_function__RigidBodies__rigidbodies(untyped_member, index));
  auto & value = *reinterpret_cast<mocap4r2_msgs::msg::RigidBody *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<mocap4r2_msgs::msg::RigidBody *>(
    get_function__RigidBodies__rigidbodies(untyped_member, index));
  const auto & value = *reinterpret_cast<const mocap4r2_msgs::msg::RigidBody *>(untyped_value);
  item = value;
}
