...
static const _CreateRigidBody_Event_type_support_symbol_names_t _CreateRigidBody_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mocap4r2_msgs, srv, CreateRigidBody_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mocap4r2_msgs, srv, CreateRigidBody_Event)),
  }
};
...
{
  return &::mocap4r2_msgs::srv::rosidl_typesupport_cpp::CreateRigidBody_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mocap4r2_msgs, srv, CreateRigidBody_Event)() {
  return get_message_type_support_handle<mocap4r2_msgs::srv::CreateRigidBody_Event>();
}
...
static const rosidl_service_type_support_t CreateRigidBody_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mocap4r2_msgs::srv::CreateRigidBody_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mocap4r2_msgs::srv::CreateRigidBody_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mocap4r2_msgs::srv::CreateRigidBody_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, mocap4r2_msgs, srv, CreateRigidBody)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<mocap4r2_msgs::srv::CreateRigidBody>();
}
