...
bool mocap4r2_msgs__msg__imus_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap4r2_msgs.msg._imus_info", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("ImusInfo", (char *)PyUnicode_1BYTE_DATA(name_attr), 8) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  mocap4r2_msgs__msg__ImusInfo * ros_message = _ros_message;
  {  // sensor_ids
...
{
  /* NOTE(esteve): Call constructor of ImusInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mocap4r2_msgs.msg._imus_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImusInfo");
