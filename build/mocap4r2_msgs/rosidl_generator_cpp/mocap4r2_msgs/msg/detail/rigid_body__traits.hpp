...
// Member 'markers'
#include "mocap4r2_msgs/msg/detail/marker__traits.hpp"
// Member 'pose'
...
inline void to_yaml(
  const mocap4r2_msgs::msg::RigidBody & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mocap4r2_msgs::msg::RigidBody & msg)
{
