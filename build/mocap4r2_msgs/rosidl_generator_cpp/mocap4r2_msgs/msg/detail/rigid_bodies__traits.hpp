...
// Member 'rigidbodies'
#include "mocap4r2_msgs/msg/detail/rigid_body__traits.hpp"
...
inline void to_yaml(
  const mocap4r2_msgs::msg::RigidBodies & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mocap4r2_msgs::msg::RigidBodies & msg)
{
